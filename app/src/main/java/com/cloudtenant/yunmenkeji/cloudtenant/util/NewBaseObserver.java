...
public abstract class NewBaseObserver<T> implements Observer<NewBaseBean> {
    protected Context mContext;

    public NewBaseObserver(Context cxt) {
        this.mContext = cxt;
    }
    ...
    @Override
    public void onNext(NewBaseBean tBaseEntity) {
        onRequestEnd();
...
//        Log.w(TAG, "onError: ", );这里可以打印错误信息
     ...
     * @throws Exception
     */
    protected abstract void onSuccees(NewBaseBean t) throws Exception;
